...
int main()
{
    ...
    bilete.push_back(Rezervare(2,3,{"Ionescu", "Andreea" ,16},{"Hereditary","Horror","22:00",127,22.00,"2D",18}));
    bilete.push_back(Rezervare(2,3,{"Popescu", "Sabina", 11},{"Abominable","Animatie","13:00",97,22.00,"3D",3}));
